...
units = {
  ...
  right70       = { x = 0.35, y = 0.00, w = 0.67, h = 1.00 },
  mid30         = { x = 0.33, y = 0.00, w = 0.34, h = 1.00 },
...
-- left 1/3, right 2/3
hs.hotkey.bind(smash, '[',    function() hs.window.focusedWindow():move(units.left30,     nil, true) end)
hs.hotkey.bind(smash, ']',    function() hs.window.focusedWindow():move(units.right70,    nil, true) end)

-- mid 1/3, maximum
hs.hotkey.bind(mash, 'p',     function() hs.window.focusedWindow():move(units.mid30,      nil, true) end)
