...
"		let commentSymbol == "'"
"	elseif fileType == 'plsql' || fileType == 'lua' || fileType == 'haskell'
"		let commentSymbol = '--'
"	else
...
function s:FindCommentify() " {{{
	...
	if fileType == 'ox' || fileType == 'cpp' || fileType == 'php' || fileType == "javascript" || fileType == 'java' || fileType == 'ooc'
		let commentSymbol_L = '//'
		let commentSymbol_R = ''
	...
	elseif fileType == 'html' || fileType == 'xhtml' || fileType == 'xml' || fileType == 'ant'
		let commentSymbol_L = '<!-- '
		let commentSymbol_R = ' -->'
...
"		let commentSymbol_R = '*/'
	...
	elseif fileType == 'm4' || fileType == 'config' || fileType == 'automake'
		...
		let commentSymbol_R = ''
	elseif fileType == 'ruby' || fileType == 'python' || fileType == 'perl' || fileType == 'make' || fileType == 'sh' || fileType == 'tcl' || fileType == 'jproperties'
		let commentSymbol_L = '#'
		let commentSymbol_R = ''
	elseif fileType == 'vb' || fileType == 'aspvbs'
		let commentSymbol_L == "'"
		let commentSymbol_R = ''
	elseif fileType == 'plsql' || fileType == 'lua' || fileType == 'sql'
		let commentSymbol_L = '--'
		let commentSymbol_R = ''
	elseif fileType == 'haskell'
		let commentSymbol_L = '--'
		let commentSymbol_R = ''
	elseif fileType == 'asm' || fileType == 'masm' || fileType == 'nasm' || fileType == 'fasm'
		let commentSymbol_L = ';'
		let commentSymbol_R = ''
...
"		let commentSymbol_R = ''
"		"echo "ToggleCommentify: Unknown filetype, defaulting to CPP style //"
		"echo "ToggleCommentify: Unknown filetype, defaulting #"
		"let commentSymbol_L = '//'
		let commentSymbol_L = '#'
		let commentSymbol_R = ''
	endif
