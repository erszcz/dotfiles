...
try
	...
	call s:hi( 'Normal'       , 'none'   , 'grey'        , 'grey1'      )

	call s:hi( 'Cursor'       , 'none'   , 'black'       , 'green'      )
	call s:hi( 'CursorColumn' , 'none'   , 'none'        , 'grey4'      )
	call s:hi( 'CursorLine'   , 'none'   , 'none'        , 'grey3'      )
	...
	call s:hi( 'LineNr'       , 'none'   , 'yellow'      , 'none'       )
	call s:hi( 'MatchParen'   , 'bold'   , 'white'       , 'black'      )
	...
	call s:hi( 'Comment'      , 'none'   , 'darkyellow'  , 'none'       )
